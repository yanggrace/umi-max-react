...
import { getDealerStockReportDetail } from '../service';
import { cloneDeep } from 'lodash';
import { Container } from '@/utils/index';

function DetailModal({ visible, setVisible, curRecord, getWeek }) {
    const columns = [
    ...
    >
        <ProTable
            ...
            request={async params => {
                ...
                return getDealerStockReportDetail(newParams).then(res => handleProTableRes(res))
            }}
        />
    </Modal>)
