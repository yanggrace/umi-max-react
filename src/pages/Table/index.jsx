...
import {initColumnsStateMap, columnsStateMapToArray} from '@/utils/index';
...
const TableList = () => {
  ...
  const [columnsStateMap, setColumnsStateMap] = useState(initColumnsStateMap(columns));
  return (
    <PageContainer
      header={{
        title: 'CRUD 示例',
    ...
    >
      <ProTable
        ...
        columnsState={{
          ...
          onChange: (columns) => {
            console.log(columnsStateMapToArray(columns));
            console.log(columns);
